...
<html>
    ...
    <h1 style="text-align:center;">Check PNR Status</h1>
    <body style="background-color:grey; padding:150px;" >
...
<center>
                        ...
                        <br> <br><br>
                                ...
                                <br>
                                    <input type="text" id="u_id" name="pnr" class="form-control" style="padding:20px; width:300px; margin-left: 66px;" placeholder="Enter Your PNR Number"><br>
